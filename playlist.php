...
<section class="playlist">
   ...
   <h1 class="heading" data-aos="zoom-out">تفاصيل قائمة التشغيل</h1>
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list" data-aos="zoom-out" data-aos-delay="200">
            <input type="hidden" name="list_id" value="<?= $playlist_id; ?>">
            <?php
               if($select_bookmark->rowCount() > 0){
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>عدم الحفظ</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>حفظ قائمة التشغيل</span></button>
            <?php
               }
            ?>
         </form>
         <div class="thumb" data-aos="zoom-out" data-aos-delay="400">
            <span><?= $total_videos; ?> فيديوهات</span>
            <img src="uploaded_files/<?= $fetch_playlist['thumb']; ?>" alt="">
         </div>
      </div>

      <div class="col" data-aos="zoom-out" data-aos-delay="600">
         <div class="tutor">
...
<section class="videos-container">
   ...
   <h1 class="heading" data-aos="zoom-out">مقاطع فيديو قائمة التشغيل</h1>

   <div class="box-container" data-aos="zoom-out" data-aos-delay="200">

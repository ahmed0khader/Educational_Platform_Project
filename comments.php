...
<section class="edit-comment">
   ...
   <form action="" method="post" data-aos="zoom-out" data-aos-delay="200">
      ...
      <div class="flex">
         <a href="comments.php" class="inline-option-btn">إلغاء التحرير</a>
...
<section class="comments">
   ...
   <h1 class="heading" data-aos="zoom-out">تعليقاتك</h1>

   
   <div class="show-comments" data-aos="zoom-out" data-aos-delay="200">
      <?php
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         <div class="content"><span><?= $fetch_comment['date']; ?></span><p> - <?= $fetch_content['title']; ?> - </p><a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>">عرض المحتوى</a></div>
         ...
         <form action="" method="post">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');">حذف تعليق</button>
         </form>
         <?php
         }
         ?>

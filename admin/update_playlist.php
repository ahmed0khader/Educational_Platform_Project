...
if(isset($_POST['submit'])){
   ...
   $message[] = 'تم تحديث قائمة التشغيل!';  
...
<head>
   ...
   <title>تحديث قائمة التشغيل</title>
...
<section class="playlist-form">
   ...
   <h1 class="heading">تحديث قائمة التشغيل</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="أدخل عنوان قائمة التشغيل" value="<?= $fetch_playlist['title']; ?>" class="box">
      <p>وصف قائمة التشغيل <span>*</span></p>
      <textarea name="description" class="box" required placeholder="اكتب الوصف" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
      ...
      <input type="submit" value="تحديث قائمة التشغيل" name="submit" class="btn">
      <div class="flex-btn">
         <input type="submit" value="حذف" class="delete-btn" onclick="return confirm('حذف قائمة التشغيل هذه؟');" name="delete">
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">عرض قائمة التشغيل</a>
      </div>
   </form>
   <?php
      } 

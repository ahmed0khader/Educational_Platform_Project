   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            ...
            <input type="password" name="old_pass" placeholder="أدخل كلمة المرور القديمة" maxlength="20"  class="box">
            <p>كلمة المرور الجديدة :</p>
            <input type="password" name="new_pass" placeholder="أدخل كلمة المرور الجديدة" maxlength="20"  class="box">
            <p>تأكيد كلمة المرور :</p>
            <input type="password" name="cpass" placeholder="تأكيد كلمة المرور" maxlength="20"  class="box">
         </div>
      </div>
      <p>صورة الملف الشخصي :</p>
      <input type="file" name="image" accept="image/*"  class="box">
      <input type="submit" name="submit" value="تحديث البيانات" class="btn">
   </form>

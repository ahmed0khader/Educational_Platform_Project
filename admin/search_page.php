...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">عرض المحتوى</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">لم يتم العثور على محتويات!</p>';
      }
   }else{
...
<section class="playlists">
   ...
   <h1 class="heading">قوائم التشغيل</h1>
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">لا توجد قوائم تشغيل!</p>';
      }}else{
         echo '<p class="empty">الرجاء البحث عن شيء!</p>';
      }
      ?>

...
<section class="tutor-profile" style="min-height: calc(100vh - 19rem);"> 
   ...
   <h1 class="heading">تفاصيل الملف الشخصي</h1>
   ...
   <div class="details">
      ...
      <div class="flex">
         <div class="box">
            ...
            <a href="playlists.php" class="btn">عرض قوائم التشغيل</a>
         </div>
         <div class="box">
            <span><?= $total_contents; ?></span>
            <p>إجمالي مقاطع الفيديو</p>
            <a href="contents.php" class="btn">عرض المحتويات</a>
         </div>
         <div class="box">
            <span><?= $total_likes; ?></span>
            <p>إجمالي الإعجابات</p>
            <a href="contents.php" class="btn">عرض الإعجابات</a>
         </div>
         <div class="box">

...
<head>
   ...
   <title>تفاصيل قائمة التشغيل</title>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">تحديث قائمة التشغيل</a>
            <input type="submit" value="حذف قائمة التشغيل" class="delete-btn" onclick="return confirm('حذف قائمة التشغيل هذه؟');" name="delete">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">لا توجد قائمة تشغيل!</p>';
      }
   ?>
...
<section class="contents">
   ...
   <h1 class="heading">مقاطع فيديو قائمة التشغيل</h1>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_content.php?get_id=<?= $video_id; ?>" class="option-btn">تحديث</a>
            <input type="submit" value="حذف" class="delete-btn" onclick="return confirm('حذف هذا الفيديو؟');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">شاهد الفيديو</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">لم تتم إضافة مقاطع فيديو حتى الآن! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">إضافة مقاطع فيديو</a></p>';
      }
   ?>

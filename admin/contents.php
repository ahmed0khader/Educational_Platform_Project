...
<section class="contents">
   ...
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">إنشاء محتوى جديد</h3>
      <a href="add_content.php" class="btn">إضافة محتوى</a>
   </div>
   ...
   <?php
         ...
         echo '<p class="empty">لم تتم إضافة أي محتويات حتى الآن!</p>';
      }
   ?>

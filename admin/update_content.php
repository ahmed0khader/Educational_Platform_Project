...
<section class="video-form">
   ...
   <h1 class="heading">تحديث المحتوى</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>عنوان التحديث <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="أدخل عنوان الفيديو" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>وصف التحديث <span>*</span></p>
      <textarea name="description" class="box" required placeholder="اكتب الوصف" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>تحديث قائمة التشغيل</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>حدد قائمة التشغيل--</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>لم يتم إنشاء قائمة تشغيل حتى الآن!</option>';
         }
         ?>
      </select>
      <img src="../uploaded_files/<?= $fecth_videos['thumb']; ?>" alt="">
      <p>تحديث الصورة المصغرة</p>
      <input type="file" name="thumb" accept="image/*" class="box">
      <video src="../uploaded_files/<?= $fecth_videos['video']; ?>" controls></video>
      <p>تحديث الفيديو</p>
      <input type="file" name="video" accept="video/*" class="box">
      <input type="submit" value="تحديث المحتوى" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">عرض المحتوى</a>
         <input type="submit" value="حذف المحتوى" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">الفيديو غير موجود! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">إضافة مقاطع فيديو</a></p>';
      }
   ?>

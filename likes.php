...
<section class="liked-videos">
   ...
   <h1 class="heading" data-aos="zoom-out">مقاطع تعجبني</h1>
   ...
   <div class="box" data-aos="zoom-out" data-aos-delay="200">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">شاهد الفيديو</a>
         <input type="submit" value="حذف" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
         }else{
            echo '<p class="emtpy">لم يتم العثور على المحتوى!</p>';         
         }
      }
   }else{
      echo '<p class="empty">لا شيء يضاف إلى الإعجابات حتى الآن!</p>';
   }
   ?>
